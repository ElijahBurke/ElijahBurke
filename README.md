...
Hello World! I'm a Full Stack Developer from London who's passionate about clean code and all things JavaScript. I fell in love with coding as it was all the things I loved about maths when i was studying - in particular the challenge that arises from meeting problems and the intricacies of solving them. I am proficient in many languages and technologies on the front and back end, including React, Angular, JavaScript, TypeScript, GraphQL, PostgreSQL, Sequelize, NodeJS, MongoDB & Mongoose and love learning new ones!
...
#### [My Portfolio](elijah-burke.tech/)
